...
--
-- Host: localhost
-- Generation Time: Aug 27, 2011 at 09:50 AM
...
CREATE TABLE IF NOT EXISTS `car` (
  ...
  `photo` varchar(100) COLLATE utf8_unicode_ci DEFAULT 'car.png',
  PRIMARY KEY (`id`),
...
('69302082b3efa8143602bd9eacf62702', '127.0.0.1', 'Mozilla/5.0 (X11; Linux i686) AppleWebKit/534.30 (', 1314431339, 0x613a323a7b733a343a2263697479223b733a363a22416c6d617479223b733a373a22636974795f6964223b733a313a2231223b7d);
...
(1, 4, 'Алматы Такси', 50, 5, 1, 'Адрес:\nРК, г. Алматы, мкрн. "Сайран" 17\nТелефоны:\nВызов такси: +7 (727) 2 555 - 333\nПриемная: +7 (727) 2 258 855\nФакс: +7 (727) 2 250 111\nE-mail: info@almatytaxi.kz ', 'Сегодня, ТОО «Алматы-Такси» самый крупный таксомоторный парк не только в Казахстане, но и во всей Центральной Азии, являющийся лидером среди транспортных компаний по перевозкам пассажиров и багажа!', 'http://localhost/vacanttaxi/style/uploads/company_logos/MinHo.jpg', 'http://almatytaxi.kz/'),
